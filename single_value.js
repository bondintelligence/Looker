looker.plugins.visualizations.add({
    ...
    create: function(element, config) {
      ...
      element.innerHTML = `
        ...
        <p style="color:#d1d1d1;font-size:78px;margin: 40px 10px 10px 10px; border: 2px solid white;" id="title"></p><p style="color:#9b9ea3;font-size:30px; margin: 10px 10px 0px 10px;height: 20px;" id="subtitle"></p>
