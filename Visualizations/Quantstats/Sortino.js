looker.plugins.visualizations.add({
    ...
    create: function(element, config){
      ...
      </style><div id="sortino_visual"></div>`;
    ...
    updateAsync: function(data, element, config, queryResponse, details, done){
      ...
      fetch('https://quantstats-wmn5n7rc5q-uc.a.run.app/getdata/rsortino/'+Strat_CUSIP+'/'+Bench_CUSIP)
      ...
      .then(json => {
        ...
        Plotly.newPlot('sortino_visual', data, layout);
        done();
      });
