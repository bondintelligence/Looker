looker.plugins.visualizations.add({
  ...
  updateAsync: function (data, element, config, queryResponse, details, done) {
    ...
    for (let i = 0; i < data.length; i++){
      ...
      yield_var[currClassif-1].push(row["rel_val_corp.yield"].value)
      CUSIP[currClassif-1].push(row["rel_val_corp.cusip"].value)
    }

    // Initializing data from arrays based on classifications from 1 to 16
    var data = [
        {x: price[0], y: risk[0], z: yield_var[0], text: CUSIP[0], type: 'scatter3d', name: 'Classif: 1',
        ...
        {x: price[1], y: risk[1], z: yield_var[1], text: CUSIP[1], type: 'scatter3d', name: 'Classif: 2',
        ...
        {x: price[2], y: risk[2], z: yield_var[2], text: CUSIP[2], type: 'scatter3d', name: 'Classif: 3',
        ...
        {x: price[3], y: risk[3], z: yield_var[3], text: CUSIP[3], type: 'scatter3d', name: 'Classif: 4',
        ...
        {x: price[4], y: risk[4], z: yield_var[4], text: CUSIP[4], type: 'scatter3d', name: 'Classif: 5',
        ...
        {x: price[5], y: risk[5], z: yield_var[5], text: CUSIP[5], type: 'scatter3d', name: 'Classif: 6',
        ...
        {x: price[6], y: risk[6], z: yield_var[6], text: CUSIP[6], type: 'scatter3d', name: 'Classif: 7',
        ...
        {x: price[7], y: risk[7], z: yield_var[7], text: CUSIP[7], type: 'scatter3d', name: 'Classif: 8',
        ...
        { x: price[8], y: risk[8], z: yield_var[8], text: CUSIP[8], type: 'scatter3d', name: 'Classif: 9',
        ...
        { x: price[9], y: risk[9], z: yield_var[9], text: CUSIP[9], type: 'scatter3d', name: 'Classif: 10',
        ...
        { x: price[10], y: risk[10], z: yield_var[10], text: CUSIP[10], type: 'scatter3d', name: 'Classif: 11',
        ...
        { x: price[11], y: risk[11], z: yield_var[11], text: CUSIP[11], type: 'scatter3d', name: 'Classif: 12',
        ...
        { x: price[12], y: risk[12], z: yield_var[12], text: CUSIP[12], type: 'scatter3d', name: 'Classif: 13',
        ...
        { x: price[13], y: risk[13], z: yield_var[13], text: CUSIP[13], type: 'scatter3d', name: 'Classif: 14',
        ...
        { x: price[14], y: risk[14], z: yield_var[14], text: CUSIP[14], type: 'scatter3d', name: 'Classif: 15',
        ...
        { x: price[15], y: risk[15], z: yield_var[15], text: CUSIP[15], type: 'scatter3d', name: 'Classif: 16',
