...
view: muni {
  ...
  dimension: alternative_trading_system_ats_indicator {
    type: yesno
    label: "alternative_trading_system_ats_indicator"
  ...
  dimension: list_offering_price_takedown_indicator {
    type: yesno
    label: "list_offering_price_takedown_indicator"
  ...
  dimension: non_transaction_based_compensation_arrangement_ntbc_indicator {
    type: yesno
    label: "non_transaction_based_compensation_arrangement_ntbc_indicator"
